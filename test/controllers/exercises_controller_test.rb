...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { name: @exercise.name, weight: @exercise.weight, workout: @exercise.workout } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { name: @exercise.name, weight: @exercise.weight, workout: @exercise.workout } }
